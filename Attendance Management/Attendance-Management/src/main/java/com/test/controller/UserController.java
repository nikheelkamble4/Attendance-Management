...
public class UserController 
{
    ...
    {
    	String tempPsid = user.getPsid();
        if(tempPsid!=null && !"".equals(tempPsid)){
            User userobj = userService.fetchUserByPsid(tempPsid);
            if(userobj != null){
                throw new Exception("user with "+ tempPsid + "is allready exist");
            }
        }
        User userObj =null;
    ...
    public  User loginUser(@RequestBody User user) throws Exception 
    {
        ...
        User userObj = null;
        if(tempPsid !=null && tempPass != null)
        {
            userObj = userService.fetchUserByPsidAndPassword(tempPsid,tempPass);
        }
        if (userObj==null)
        {
